...
namespace WebUI.Data
{
    public class MainDataService
    {
        ...
        public List<Book> SearchBook(string sTopic, string sTerm, string sFilter)
        {

            //If Local Library file doesn't have data, establishe API connection with Google Books to retrieve books 
            if (_library == null)
            {
                GoogleBooksJson.Root GBCollection = Help.GoogleBookAPIConnector(sTopic, sTerm, sFilter);
